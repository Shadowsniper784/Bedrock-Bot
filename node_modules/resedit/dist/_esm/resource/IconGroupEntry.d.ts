...
export default class IconGroupEntry {
    ...
    private constructor();
    static fromEntries(entries: readonly ResourceEntry[]): IconGroupEntry[];
    generateEntry(): ResourceEntry;
    /**
     ...
     */
    getIconItemsFromEntries(entries: readonly ResourceEntry[]): Array<IconItem | RawIconItem>;
    /**
     ...
     */
    static replaceIconsForResource(destEntries: ResourceEntry[], iconGroupID: string | number, lang: string | number, icons: Array<IconItem | RawIconItem>): void;
}
