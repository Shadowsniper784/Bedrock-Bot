...
var NtExecutableResource = /** @class */ (function () {
    ...
    NtExecutableResource.from = function (exe) {
        ...
        var entry = exe.getSectionByEntry(Format.ImageDirectoryEntry.Resource);
        ...
        if (entry) {
            var reloc = exe.getSectionByEntry(Format.ImageDirectoryEntry.BaseRelocation);
    ...
    NtExecutableResource.prototype.outputResource = function (exeDest, noGrow, allowShrink) {
        ...
        // write as section
        exeDest.setSectionByEntry(Format.ImageDirectoryEntry.Resource, sectionData);
        // rewrite section raw-data
        var generatedSection = exeDest.getSectionByEntry(Format.ImageDirectoryEntry.Resource);
