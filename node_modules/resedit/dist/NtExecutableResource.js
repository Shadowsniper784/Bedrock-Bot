...
var NtExecutableResource = /** @class */ (function () {
    ...
    NtExecutableResource.from = function (exe) {
        ...
        var entry = exe.getSectionByEntry(pe_library_1.Format.ImageDirectoryEntry.Resource);
        ...
        if (entry) {
            var reloc = exe.getSectionByEntry(pe_library_1.Format.ImageDirectoryEntry.BaseRelocation);
    ...
    NtExecutableResource.prototype.outputResource = function (exeDest, noGrow, allowShrink) {
        ...
        // write as section
        exeDest.setSectionByEntry(pe_library_1.Format.ImageDirectoryEntry.Resource, sectionData);
        // rewrite section raw-data
        var generatedSection = exeDest.getSectionByEntry(pe_library_1.Format.ImageDirectoryEntry.Resource);
